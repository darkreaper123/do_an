...
class DataLoaderBase(object):
    ...
    def __init__(self, args, logging):
        ...
        try:
          self.n_users = max(self.n_users, self.users_profiles["user"].max())
        except:
          print('No users features')
        self.n_users += 1
        
        try:
          self.n_items = max(self.n_items, self.items_profiles["item"].max())
        except:
          print('No items features')
        self.n_items += 1
    ...
    def statistic_cf(self):
        ...
        try:
          ...
          print('No test cold')
        try:
          self.n_users = max(self.n_users, max(self.cf_test_warm_data[0]))
        except:
          print('No test warm')
        ...
        try:
          ...
          print('No test cold')
        try:
          self.n_items = max(self.n_items, max(self.cf_test_warm_data[1]))
        except:
          print('No test warm')
