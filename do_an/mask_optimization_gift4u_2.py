...
class DistributedAdamMultiTasks_2(Optimizer):
    ...
    def __init__(self, params, lr=required, warmup=-1, t_total=-1, schedule='warmup_linear', b1=0.9, b2=0.999, e=1e-6, weight_decay=0.01, max_grad_norm=1.0):
        ...
        super(DistributedAdamMultiTasks_2, self).__init__(params, defaults)
    def get_lr(self):
        lr = []
    ...
    def step(self, closure=None, t=None, id_to_mask_params = None):
            ...
            for p_id,p in enumerate(group['params']):
                ...
                if p_id in id_to_mask_params:
                    ...
                    with torch.no_grad():
                        ...
                        task_mask_params = 1 - torch.sigmoid(task_mask_params)
                        task_mask_params = task_mask_params.reshape(-1)
                        #task_mask_params[task_mask_params >= 0.5] = 1.
                        #task_mask_params[task_mask_params < 0.5] = 0.
                        print('cak')
                        
                    update *= task_mask_params
                else:
