...
class IF2_fine_tunning_emb(nn.Module):
    ...
    def __init__(self, args,
        ...
        super(IF2_fine_tunning_emb, self).__init__()
        ...
        self.using_features_full = False
    ...
    def calc_one_embeddings(self, all_embed, ids, user_or_items, fix_weight_for_embed = None):
        ...
        if user_or_items == 1:
            ...
            if not self.using_features_full and not self.using_features_one_time:
                return embed
