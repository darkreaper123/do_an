...
class IF2_pretrained_side_information(nn.Module):
    ...
    def __init__(self, args,
        ...
        super(IF2_pretrained_side_information, self).__init__()
    ...
    def calc_one_embeddings(self, all_embed, ids, user_or_items, fix_weight_for_embed = None):
        ...
        if self.using_emb_one_time or user_or_items == 0:
            with torch.no_grad():
