...
class IF2_simple_version(nn.Module):
    ...
    def __init__(self, args,
        ...
        super(IF2_simple_version, self).__init__()
        ...
        self.just_using_embed = False
        self.during_testing = False
        self.training_model_with_users_features = False
        self.using_features_one_time = False
        self.using_embs_one_time = True
    ...
    def calc_one_embeddings(self, all_embed, ids, user_or_items, fix_weight_for_embed = None):
        ...
        #if user_or_items == 1 and self.using_features_one_time:
        if (self.using_embs_one_time and user_or_items == 1) or (user_or_items == 0):
            embed = all_embed[new_ids]
            return embed
        if self.using_features_one_time and user_or_items == 1:
